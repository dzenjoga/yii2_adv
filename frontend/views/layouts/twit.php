            ...
            <div class="panel panel-default">
              <div class="panel-body">
                ...
                <ol class="categories list-unstyled">
                  <li>
                    <a class="label label-light label-warning" href="filter-category.html">Live</a>
                    <span class="label label-light label-default pull-right">8</span>
                  </li>
                  <li>
                    <a class="label label-light label-primary" href="filter-category.html">Studio</a>
                    <span class="label label-light label-default pull-right">5</span>
                  </li>
                  <li>
                    <a class="label label-light label-info" href="filter-category.html">Albums</a>
